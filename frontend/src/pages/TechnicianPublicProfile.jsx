        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border p-6 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start mb-8">
                ...
                <div className="text-center md:text-left flex-1">
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                        ...
                        <div className="flex bg-blue-50 px-2 py-1 rounded text-blue-700 font-bold text-sm items-center gap-1">
                            <span className="text-lg">{technician.jobsCompleted || 0}</span>
                            <span className="text-xs uppercase">Jobs Done</span>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 justify-center md:justify-start">
                        ...
                        {user && user.uid !== technician.id && (
                            <button
                                onClick={() => setShowReportModal(true)}
                                className="text-slate-400 hover:text-red-500 font-bold text-xs flex items-center gap-1 transition-colors pl-2 border-l"
                            >
                                <span>🚩</span> Report
                            </button>
                        )}
            ...
            {showRequestModal && (
                <ServiceRequestModal
                    ...
                    onSuccess={() => {
                        toast.success("Service request sent successfully! Check your dashboard.")
            ...
            <ReportUserModal
                ...
                reportedUserId={technician.id}
                reportedUserName={technician.name}
            />
        </div>
    )
}
